# Generated by Django 4.2.6 on 2024-01-16 07:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cid', shortuuid.django_fields.ShortUUIDField(alphabet='marga1234', length=10, max_length=20, prefix='cat', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abc1234', length=10, max_length=20, prefix='', unique=True)),
                ...
                ('product_status', models.CharField(choices=[('draft', 'Processing'), ('disabled', 'disabled'), ('rejected', 'rejected'), ('in_review', 'in_review'), ('published', 'published')], default='in_review', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vid', shortuuid.django_fields.ShortUUIDField(alphabet='abcd1234', length=10, max_length=20, prefix='ven', unique=True)),
                ('title', models.CharField(default='Marga', max_length=100)),
                ('image', models.ImageField(upload_to=shop.models.user_directory_path)),
                ('address', models.CharField(default='kathmandu-8 ,new-road', max_length=100)),
                ('shipping_on_time', models.CharField(default='100%', max_length=100)),
                ('contact', models.CharField(default='100', max_length=100)),
